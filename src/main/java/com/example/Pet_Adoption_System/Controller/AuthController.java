...
//         // Create new user's account (do not store confirmPassword in the database)
//         User user = new User(signUpRequest.getName(),
//                 signUpRequest.getEmail(),
//                 encoder.encode(signUpRequest.getPassword()));
        
//         // Don't set confirmPassword as it shouldn't be stored
...
//                         break;
//                     case "adopter":
//                         Role adopterRole = roleRepository.findByName(ERole.ROLE_ADOPTER)
//                                 .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
//                         roles.add(adopterRole);
//                         break;
//                     default:
//                         Role userRole = roleRepository.findByName(ERole.ROLE_USER)
//                                 .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
